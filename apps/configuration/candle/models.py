...
class Candle(models.Model):
    ...
    candle_second = models.CharField(max_length=50, default=CandleEnum.NONE.value, choices=[(candle.name, candle.value) for candle in CandleEnum])
    candle_sell = models.CharField(max_length=50, choices=[(candle.name, candle.value) for candle in CandleEnum])
    candle_sell_second = models.CharField(max_length=50, default=CandleEnum.NONE.value, choices=[(candle.name, candle.value) for candle in CandleEnum])
    class Meta:
